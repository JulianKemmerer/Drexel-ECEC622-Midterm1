...
////////////////////////////////////////////////////////////////////////////////
int check_chol(const Matrix, const Matrix);
...
extern void print_matrix(const Matrix);
extern void pattern_print(int read,int element_index, int x, int y);
			  ...
			  // Elimination step
				...
				for(i = (k + 1); i < U.num_rows; i++)
				{
					for(j = i; j < U.num_rows; j++)
					{
						...
						//pattern_print(1,k * U.num_rows + j,k,j);
						//pattern_print(1,k * U.num_rows + i,k,i);
						//pattern_print(1,i * U.num_rows + j,i,j);
						//pattern_print(0,i * U.num_rows + j,i,j);
					}
				}
